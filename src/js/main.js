...
const dataAws = [
  ...
  
  {
      ...
      lectures: [
          ...
          {
              title: 'Lab: Application Load Balancer + Launch Template + Target Group',
              display_order: 4,
              video_id: '',
              video_duration: 0,
              server_id: 0,
  ...
  },
  {
      ...
      lectures: [
          ...
          {
              title: 'Lab: Spring Boot - Web Flux - Server Sent - DynamoDB Stream - P1',
              display_order: 2,
              video_id: '',
              video_duration: 0,
              server_id: 0,
          ...
          {
              title: 'Lab: Spring Boot - Web Flux - Server Sent - DynamoDB Stream - P2',
              display_order: 3,
              video_id: '',
              video_duration: 0,
              server_id: 0,
  ...
  },
  {
      ...
      lectures: [
          ...
          {
              title: 'Lab: bắt sự thay đổi trong DynamoDB bằng DynamoDB stream + Lambda',
              display_order: 3,
              video_id: '',
              video_duration: 0,
              server_id: 0,
  ...
  },
  {
      ...
      lectures: [
          ...
          {
              title: 'Lab: (Self study) thay đổi cấu hình Database và Monitor database workload, log, event',
              display_order: 7,
              video_id: '',
              video_duration: 0,
              server_id: 0,
